...
std::pair<double, double> calculate_yaw(double t_cur, Eigen::Vector3d &pos, ros::Time &time_now, ros::Time &time_last)
{
  ...
  double max_yaw_change = limit_yaw_change * YAW_DOT_MAX_PER_SEC * (time_now - time_last).toSec();
...
void finish_ego_cb(const std_msgs::Bool::ConstPtr &msg)
{
  if (msg->data == true)
  {
    using_ego = false;
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber finish_ego_sub = nh.subscribe("/finish_ego", 10, finish_ego_cb);
