...
int main(int argc, char **argv)
{
  ...
  while (ros::ok())
  {
    ...
    switch (mission_num)
    {
      ...
      case 12:
        if(qr_mission(target_qr_x , target_qr_y , VIEW_ALTITUDE , 0 , read_data))
        {
          mission_num = 13;
        }
        break;
      ...
      case 21:
        if (mission_view(target1_x , target1_y , VIEW_ALTITUDE , 0 , err_max))
        {
          mission_num = 22;
          box_flag = true;
        }
      ...
      //pass_ring
      case 8:
        if(ring_mission(target_ring_x,target_ring_y,RING_HEIGHT,-1.57,err_max))
        {
          mission_num = 81;
        }
	      break;
      ...
      case 81:
        if(mission_pos_cruise(5.2,-2.0,RING_HEIGHT,-1.57,err_max))
        {
          mission_num = 9;
        }
	      break;
      ...
      case 9:
        if(mission_pos_cruise(target6_x,target6_y,ALTITUDE,-3.14,err_max))
        {
          mission_num = 100;
        }
	      break;
      ...
      case 100:
        ...
        if(mission_pos_cruise(target6_x,target6_y,0.01,0,err_max)){
          if (arming_client.call(arm_cmd) && arm_cmd.response.success)
          {
