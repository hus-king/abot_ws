...
tmux send-keys -t ros_session:0.3 'sleep 4;source ~/xxuz_ws/devel/setup.bash; roslaunch door_detector door_detector.launch' C-m
...
tmux send-keys -t ros_session:1.1 'sleep 6; rostopic echo /door_center' C-m

# Pane 2: complete_mission.launch
tmux split-window -v -t ros_session:1.1
tmux send-keys -t ros_session:1.2 'sleep 7; roslaunch complete_mission cross_door_pro.launch' C-m
