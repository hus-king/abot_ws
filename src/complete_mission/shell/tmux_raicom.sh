...
tmux send-keys -t ros_session:0.2 'sleep 4; roslaunch usb_cam usb_cam-test.launch' C-m

# Pane 4: rs_camera.launch
tmux split-window -h -t ros_session:0.2
tmux send-keys -t ros_session:0.3 'sleep 4; roslaunch astra_camera gemini.launch' C-m

# Pane 4: rs_camera.launch
tmux split-window -h -t ros_session:0.3
tmux send-keys -t ros_session:0.4 'sleep 10; roslaunch complete_mission ego_planner_mid360.launch' C-m

# Pane 4: rs_camera.launch
tmux split-window -h -t ros_session:0.4
tmux send-keys -t ros_session:0.5 'sleep 12; rosrun complete_mission laser_to_worldframe' C-m
...
tmux send-keys -t ros_session:1 'sleep 4; roslaunch paddle_ocr_ros dual_cam_ocr.launch' C-m

# Pane 6: qr_detection
tmux split-window -h -t ros_session:1
tmux send-keys -t ros_session:1.1 'sleep 4; roslaunch complete_mission shoot.launch' C-m

# Pane 7: circle_detector.launch
tmux split-window -h -t ros_session:1.1
tmux send-keys -t ros_session:1.2 'sleep 4; roslaunch complete_mission servo.launch' C-m
...
tmux send-keys -t ros_session:2.1 'sleep 4; rostopic echo /ocr_results/front' C-m

# Pane 2: /qr_code_detection/qrcode_data
tmux split-window -v -t ros_session:2.0
tmux send-keys -t ros_session:2.1 'sleep 4; rostopic echo /ocr_results/down' C-m

# Pane 3: complete_mission.launch
tmux split-window -v -t ros_session:2.1
tmux send-keys -t ros_session:2.2 'sleep 4; roslaunch complete_mission complete_mission.launch' C-m
