...
tmux send-keys -t ros_session.1 'sleep 3; roslaunch abot_bringup location.launch' C-m
...
tmux send-keys -t ros_session.4 'sleep 4; roslaunch complete_mission camera_ar.launch' C-m
tmux send-keys -t ros_session.4 'exec bash' C-m

tmux rename-window main

# 创建window启动yolo
tmux new-window -t ros_session -n yolo
tmux send-keys -t ros_session:yolo 'sleep 4; roslaunch opencv_cpp_yolov5 opencv_cpp_yolov5.launch' C-m
