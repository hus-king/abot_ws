...
float position_z       = 0.8;
float position_z_param = 0.8;
...
{
   OffboardControl_.send_body_velxy_posz_yaw_setpoint(px4_vel_,position_z,yaw_speed);
...
void PX4RosNav::CmdVelCallback(const geometry_msgs::Twist &msg)
{
 ...
 //nh_.param<float>("desire_posz_", desire_posz_, 0.5);
}
...
int main(int argc, char** argv)
{
  ...
  ros::param::get("position_z_param", position_z_param);
  position_z = position_z_param;
